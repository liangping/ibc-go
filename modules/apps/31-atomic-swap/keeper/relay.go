...
func (k Keeper) SendSwap(
	...
	fullDenomPath := sendingCoin.Denom

	//var err error

	// deconstruct the token denomination into the denomination trace info
	// to determine if the sender is the source chain
	//if strings.HasPrefix(sendingCoin.Denom, "ibc/") {
	//	fullDenomPath, err = k.DenomPathFromHash(ctx, sendingCoin.Denom)
	//	if err != nil {
	//		return err
	//	}
	//}
	...
	//		ctx, sender, escrowAddress, sdk.NewCoins(sendingCoin),
	//	); err != nil {
	//		return err
	//	}
	//
...
func (k Keeper) OnRecvPacket(ctx sdk.Context, packet channeltypes.Packet, data types.SwapPacketData) error {
	...
	//if types.ReceiverChainIsSource(packet.GetSourcePort(), packet.GetSourceChannel(), data.ReceivingTokenDenom) {
