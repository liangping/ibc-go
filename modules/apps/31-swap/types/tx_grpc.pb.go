...
func (c *msgClient) Swap(ctx context.Context, in *MsgSwap, opts ...grpc.CallOption) (*MsgSwapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ibc.applications.swap.v1.Msg/Swap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Swap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ibc.applications.swap.v1.Msg/Swap",
	}
...
var Msg_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ibc.applications.swap.v1.Msg",
	...
	Metadata: "ibc/applications/swap/v1/tx.proto",
}
